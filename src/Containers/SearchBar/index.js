...
class SearchBar extends Component {
  ...
  typeWriter = () => {
    ...
    if (this.styleVar.i < this.styleVar.message.length) {
      msg =
        this.search.getAttribute("placeholder") +
        this.styleVar.message.charAt(this.styleVar.i);
      ...
      <div className="search">
        <div className="search__contain">
          <div className="search__icon" onClick={this.toggleListen}>
            {!this.props.searchBar.loading ? (
              <img
                ref={this.searchBtnRef}
                className=""
                src={this.props.icon || microphoneSvg}
                alt="search button"
              />
            ) : (
              <img
          ...
          <input
            ...
            value={this.props.searchBar.filterText}
          />
        </div>
        <p className="search__tip" ref={this.tipRef}>
          {this.props.tip ||
            "Presione el botón para hablar y vuelva a presionarlo para buscar"}
        </p>
